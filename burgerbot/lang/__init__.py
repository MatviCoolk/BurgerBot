...
class Language:
    lang_code: str; error_occurred: str; bug_cmd: str; into_the_menu: str; start: str; author: str; how_to_use_btn: str
    how_to_use: str; faq_btn: str; faq: str; profile: str; subscribe: str; more: str; back_to_the_menu: str
    what_can_this_bot_do: str; forwarding: str; next: str; share: str; idea: str; upload_burger: str; back: str
    author_btn: str; bug_found_btn: str; report: str; join_development: str

    def __init__(self, row: tuple, columns: list):
